...
namespace ProjetDev1.DAO
{
    class PlageDAO
    {
        ...
        public PlageDAO(int id, string nom, string departement, string commune, float superficie, float c1lo, float c1la, float c2lo, float c2la, float c3lo, float c3la, float c4lo, float c4la)
        {
            this.id = id;
            this.nom = nom;
        ...
        public static PlageDAO getPlage(int id)
        {
            PlageDAO p = PlageDAL.getPlage(id);
            return p;
        }
    }
}
